  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      ...
      <div class="row center">
         ...
         <a href="tienda.php" id="download-button" class="btn-large waves-effect waves-light orange">
        
           
            <h5 class="center">Clientes</h5>
        
        </a>
         <a href="login.php" id="download-button" class="btn-large waves-effect waves-light orange">
